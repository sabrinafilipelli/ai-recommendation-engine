  ...
  "node_modules/cookie/index.js"(exports) {
    ...
    function parse3(str, options2) {
      ...
      while (index4 < str.length) {
        ...
        var key3 = str.slice(index4, eqIdx).trim();
        if (void 0 === obj[key3]) {
...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"min-h-screen w-full"}">${slots.default ? slots.default({}) : ``}</div>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-f1385131.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-f1385131.js", "_app/immutable/chunks/index-adf523c1.js"];
    stylesheets = ["_app/immutable/assets/_layout-d6122ca8.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-16cc4dd6.js";
    imports2 = ["_app/immutable/components/error.svelte-16cc4dd6.js", "_app/immutable/chunks/index-adf523c1.js", "_app/immutable/chunks/singletons-238905f8.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var Home, Footer, TvIcon, Header, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_index2();
    Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"w-full"}"><div class="${"text-center md:text-left font-bold text-slate-200 text-4xl md:text-5xl mb-8 md:mb-16 w-full"}">Get curated show <br class="${"hidden md:block"}"> and movie recommendations
		<br class="${"hidden md:block"}"> with Open AI
	</div>
	<div class="${"flex flex-wrap items-center mr-auto"}"><button class="${"w-full md:w-auto text-center bg-pink-600 hover:bg-pink-700 mb-4 flex-none rounded-full text-white font-medium py-3 px-6 mr-8"}">Get recommendations
		</button></div></div>`;
    });
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"max-w-4xl mx-auto w-full flex md:flex-row flex-col items-center md:justify-between py-8 mt-20 border-t border-white/20"}"><div class="${"text-white/70 flex items-center flex-none"}">A Sabrina Filipelli project - powered by OpenAI
	</div></div>`;
    });
    TvIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill-rule="${"evenodd"}" clip-rule="${"evenodd"}" d="${"M23.25 19.9C23.2578 20.4994 22.7784 20.9918 22.179 21H1.821C1.22159 20.9918 0.742216 20.4994 0.75 19.9V5.6C0.742216 5.00058 1.22159 4.50823 1.821 4.5H22.179C22.7784 4.50823 23.2578 5.00058 23.25 5.6V19.9Z"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path><path d="${"M3.75 21V23.25"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path><path d="${"M20.25 21V23.25"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path><path d="${"M6.75 0.75L12 4.5L17.25 0.75"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path><path fill-rule="${"evenodd"}" clip-rule="${"evenodd"}" d="${"M19.505 15.118C19.4657 16.7347 18.1289 18.0165 16.512 17.988L7.512 18.009C5.89523 18.0449 4.55241 16.7695 4.505 15.153L4.494 10.381C4.53387 8.76401 5.87077 7.48203 7.488 7.50999L16.488 7.48999C18.1048 7.45358 19.4477 8.72943 19.494 10.346L19.505 15.118Z"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path></svg></div>`;
    });
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"max-w-4xl mx-auto w-full flex md:flex-row flex-col items-center md:justify-between py-8 mb-12 border-b border-white/20"}"><button class="${"flex items-center mb-4 md:mb-0 text-white/70"}">${validate_component(TvIcon, "TvIcon").$$render($$result, {}, {}, {})}
		<div class="${"text-2xl md:text-xl font-bold ml-2"}">BingeWatcher.ai</div></button></div>`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `<div><div class="${"h-screen w-full bg-cover fixed"}" style="${"background-image: url(/background.jpg)"}"><div${add_attribute("class", `${""}  flex flex-col items-center justify-center min-h-screen w-full h-full bg-gradient-to-br from-slate-900/80 to-black/90`, 0)}></div></div>

	<div class="${"absolute inset-0 px-6 flex flex-col h-screen overflor-auto"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

		${`<div class="${"flex-grow max-w-4xl mx-auto w-full md:pt-20 flex flex-col items-center justify-center"}">${validate_component(Home, "Home").$$render($$result, {}, {}, {})}</div>`}
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-2b2db097.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-2b2db097.js", "_app/immutable/chunks/index-adf523c1.js"];
    stylesheets3 = ["_app/immutable/assets/_page-775785fa.css"];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/chunks/private.js
var OPENAI_API_KEY, OMDB_API_KEY;
var init_private = __esm({
  ".svelte-kit/output/server/chunks/private.js"() {
    OPENAI_API_KEY = "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";
    OMDB_API_KEY = "8a188e9d";
  }
});

// .svelte-kit/output/server/entries/endpoints/api/getMediaDetails/_server.ts.js
...
// .svelte-kit/output/server/entries/endpoints/api/getRecommendation/_server.ts.js
      ...
      function onParse(event) {
        if (event.type === "event") {
          ...
          try {
            ...
            const text2 = json2.choices[0].text;
            if (counter < 2 && (text2.match(/\n/) || []).length) {
              return;
            }
            const queue = encoder3.encode(text2);
...
var manifest = {
  appDir: "_app",
  appPath: "_app",
  assets: /* @__PURE__ */ new Set([".DS_Store", "background.jpg", "background.png", "favicon.png"]),
  mimeTypes: { ".jpg": "image/jpeg", ".png": "image/png" },
  _: {
    entry: { "file": "_app/immutable/start-515bdeb7.js", "imports": ["_app/immutable/start-515bdeb7.js", "_app/immutable/chunks/index-adf523c1.js", "_app/immutable/chunks/singletons-238905f8.js"], "stylesheets": [], "fonts": [] },
    nodes: [
    ...
    routes: [
      ...
      {
        id: "/api/getMediaDetails",
        pattern: /^\/api\/getMediaDetails\/?$/,
        params: [],
        page: null,
        endpoint: () => Promise.resolve().then(() => (init_server_ts(), server_ts_exports))
      },
      {
        id: "/api/getRecommendation",
